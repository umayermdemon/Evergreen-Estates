  ...
  return (
    <div>
      ...
      <div className="my-8 lg:my-16">
        <h1 className="text-center font-rubik text-4xl lg:text-5xl mb-12 lg:mb-16 font-bold text-[#30416D]" data-aos="fade-left" data-aos-duration='1000'>Why Choose Us</h1>
        <div className="mt-4 grid grid-cols-2 lg:grid-cols-5  max-w-7xl mx-auto">
          <h1 className="text-4xl lg:text-6xl font-bold font-rubik text-[#269064] col-span-2 mx-3 flex items-center justify-start lg:justify-center" data-aos="fade-right" data-aos-duration='1000'>Best <br /> Rent Service, <br /> enjoy your life</h1>
          <p className="col-span-3 text-justify font-rubik text-gray-600 mx-3 mt-4 " data-aos="zoom-in" data-aos-duration='1000'>
      ...
      <div className="max-w-7xl mx-auto my-12 lg:my-24">
        ...
        <img src="https://i.ibb.co/ZWrTthm/About-User.jpg" alt="" className="border-2 border-[#269064] rounded-full p-4 w-80 " data-aos="zoom-in" data-aos-duration='2000' />
        </div>
       
        <div>
          <h1 className="text-center font-rubik font-bold text-3xl lg:text-5xl mb-4 text-[#269064]" data-aos="fade-left" data-aos-duration='2000'>Dr. Hamza Abbas</h1>
          <h4 className="text-center font-rubik font-bold text-base lg:text-xl mb-4 text-gray-600" data-aos="zoom-out" data-aos-duration='3000'>Admin</h4>
          <p className="text-justify font-rubik text-gray-600 text-base w-[350px] md:w-[600px] lg:w-[700px] mx-auto" data-aos="zoom-out" data-aos-duration='3000'>As the owner of a dynamic real estate company, you epitomize innovation, integrity, and client-centric service. Your astute leadership guides a team committed to excellence, offering unparalleled expertise in navigating the ever-evolving real estate landscape. With a passion for connecting people with their ideal properties, you create  experiences that transcend mere transactions. Beyond business, your dedication to community enrichment and philanthropy reflects a deeper commitment to societal well-being. Your unwavering drive, coupled with a genuine desire to exceed expectations, establishes you as a trusted authority and valued partner in the realm of real estate.</p>
        </div>
      </div>
    </div>
    </div>
