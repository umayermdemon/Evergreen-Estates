...
const About = () => {
  return (
    <div>
      ...
      <div className="my-16">
        <h1 className="text-center font-rubik text-5xl mb-16 font-bold text-[#30416D]">Why Choose Us</h1>
        <div className="mt-4 grid grid-cols-5  max-w-7xl mx-auto">
          <h1 className="text-6xl font-bold font-rubik text-[#269064] col-span-2 flex items-center justify-center">Best <br /> Rent Service, <br /> enjoy your life</h1>
          <p className="col-span-3 text-justify font-rubik text-gray-600 ">
