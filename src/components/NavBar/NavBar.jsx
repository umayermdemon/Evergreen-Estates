...
import { removeEstates } from "../../Utils/localStorage";
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ...
                : "flex text-sm lg:text-base items-center gap-2  text-[#0B2B4F] pr-2 lg:pr-4"
            }
          >
      ...
      <Navbar className=" mx-auto max-w-7xl  border-none p-2 bg-gradient-to-r from-[#d8ded6] to-[#e8bdf9]  lg:pl-4">
        <div className="relative mx-auto flex items-center justify-between text-[#0B2B4F]">
          ...
          <Typography
            as="a"
            href="#"
            className="mr-4 ml-2 font-rubik cursor-pointer py-1.5 font-bold text-2xl text-[#0B2B4F] "
          >
